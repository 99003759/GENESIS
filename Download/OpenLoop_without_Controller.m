%% Lateral Dynamics Control- Open Loop without controller
% Author: Pushkar Antony, Amit Kumar, Amiya Panda, Rama Subba Reddy 
% PS Number: 99003729, 99003775, 99003783,99003759
...
%% Open Loop Control
% System with Velocity of 100km/hr:-
clc;
Ydelta = 2461;
m = 1775;
V = 100;
...
S = stepinfo(sys)
%--------------------------------------------------------------------------
% System with velocity of 50km/hr:-
V1 = 50;
Yr1 = 0.92768;
Nr1 = -134.12;
